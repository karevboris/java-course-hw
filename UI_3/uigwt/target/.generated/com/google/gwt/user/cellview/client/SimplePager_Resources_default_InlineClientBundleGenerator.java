...
public class SimplePager_Resources_default_InlineClientBundleGenerator implements com.google.gwt.user.cellview.client.SimplePager.Resources {
  private static SimplePager_Resources_default_InlineClientBundleGenerator _instance0 = new SimplePager_Resources_default_InlineClientBundleGenerator();
  ...
  private void simplePagerStyleInitializer() {
    simplePagerStyle = new com.google.gwt.user.cellview.client.SimplePager.Style() {
      ...
      public String getText() {
        return (".GBG2FFLDLH{padding:" + ("4px"+ " " +"8px")  + ";text-align:" + ("center")  + ";}.GBG2FFLDJH{padding:" + ("4px")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GBG2FFLDKH{cursor:" + ("default")  + ";}");
      }
  ...
  private static final java.lang.String externalImage7 = "data:image/png;base64,";
  ...
  private static final java.lang.String externalImage8 = "data:image/png;base64,";
