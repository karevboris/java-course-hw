...
public class HelloClient_Generated_RestServiceProxy_ implements ui.client.HelloClient, org.fusesource.restygwt.client.RestServiceProxy {
  ...
  public void getHellos(java.lang.String id, org.fusesource.restygwt.client.MethodCallback<java.util.List<ui.shared.Hello>> callback) {
    ...
    try {
      __method.send(new org.fusesource.restygwt.client.AbstractRequestCallback<java.util.List<ui.shared.Hello>>(__method, callback) {
        protected java.util.List<ui.shared.Hello> parseResult() throws Exception {
          try {
            return org.fusesource.restygwt.client.AbstractJsonEncoderDecoder.toList(com.google.gwt.json.client.JSONParser.parse(__method.getResponse().getText()), ui.shared.Hello_Generated_JsonEncoderDecoder_.INSTANCE);
          } catch (Throwable __e) {
  ...
  public void getHellos(org.fusesource.restygwt.client.MethodCallback<java.util.List<ui.shared.Hello>> callback) {
    final org.fusesource.restygwt.client.Method __method =
    getResource()
    .get();
    __method.setDispatcher(this.dispatcher);
